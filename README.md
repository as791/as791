...
- 🔭 Things I'm currently working on:
   - Building scalable backend & data platform services
   - Applying ML / GenAI techniques (retrieval, embeddings, evaluation) in production systems
- 🌱 I’m currently learning:
   - Large Language Model systems, inference patterns, and reliability
- 👯 I’m looking to collaborate on:
   - Applied ML, GenAI, and data-intensive backend projects
- 💬 Ask me about:
   - Backend Engineering (Java, Spring, Microservices)
   - Distributed Systems & Data Engineering
   - Machine Learning & Deep Learning (applied)
   - Adversarial Attacks, Defenses, and ML robustness
